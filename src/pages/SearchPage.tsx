  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="mb-12 border-b border-white/20 pb-4">
        <h1 className="text-3xl font-black italic uppercase tracking-tighter text-[#e5e5e5] mb-2">Search Results</h1>
        <p className="text-[11px] font-bold uppercase tracking-widest text-white/50">
          Showing results for <span className="font-bold text-white">"{queryParam}"</span>
        </p>
      </div>
